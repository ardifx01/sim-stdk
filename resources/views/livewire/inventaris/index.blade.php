<div>
    ...
    <div class="p-3">
        <div class="col-md-12 d-flex justify-content-between">
            @if (Auth::user()->hasManagementRoleForInventaris())
                <x-button class="mb-2 button-add">
                    <a href="{{ route('inventaris.create') }}">Tambah Barang</a>
                </x-button>
            @endif
        </div>
        <div class="pb-5">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Yakin akan menghapus data inventaris yang dipilih?
                </div>
