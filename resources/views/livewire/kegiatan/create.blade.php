                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select" id="status" wire:model='status'>
                                        ...
                                        @foreach (App\Enums\StatusKegiatanEnum::cases() as $status)
                                ...
                                <div class="mb-3 col-md-12" wire:ignore>
                                    ...
                                    <textarea id="summernote" name="keterangan" class="form-control"></textarea>
                                    <div style="color: red; font-size: 12px">
                                        @error('keterangan')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="mt-1 justify-content-between d-flex">
                                    <button type="button" class="button btn-delete"><a
                                            href="{{ route('kegiatan.index') }}">Back</a></button>
