    ...
    <div>
        ...
        <div class="p-3">
            <div class="col-md-12 d-flex justify-content-between">
                @if (Auth::user()->hasManagementRoleForVerificationAnggota())
                    <x-button style="background-color: #1DCD9F" class="mb-2 button-add"><a
                            href="{{ route('anggota.verifikasi') }}">Verifikasi
                            User</a>
                    </x-button>
                @endif
                @if (Auth::user()->hasManagementRoleForAnggota())
                                    ...
                                    <tr wire:key="{{ $user->id }}">
                                        ...
                                        <td>
                                            ...
                                            @if (Auth::user()->hasManagementRoleForAnggota())
                                                ...
                                                {{-- button delete --}}
                                                <button class="mr-1 mb-md-1 button btn-delete "
